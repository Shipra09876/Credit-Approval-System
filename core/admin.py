...
class CustomerAdmin(admin.ModelAdmin):
    list_display=['customer_id','first_name','last_name','phone_number','monthly_salary','age','approved_limit','current_debt','credit_score']
...
class LoanAdmin(admin.ModelAdmin):
    ...
    list_filter=['c_id','loan_amount','interest_rate','monthly_installment','status','start_date','end_date']
